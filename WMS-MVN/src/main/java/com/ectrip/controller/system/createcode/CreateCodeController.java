package com.ectrip.controller.system.createcode;
...
import com.ectrip.util.DateUtil;
import com.ectrip.util.DelAllFile;
import com.ectrip.util.FileDownload;
import com.ectrip.util.FileZip;
import com.ectrip.util.Freemarker;
...
public class CreateCodeController extends BaseController {
	...
	public void save(PageData pd) throws Exception{
		...
		pd.put("TABLENAME", pd.getString("tabletop")+",ectrip,"+pd.getString("objectName").toUpperCase());	//表名
