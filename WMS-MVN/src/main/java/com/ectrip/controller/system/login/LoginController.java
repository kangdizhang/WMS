package com.ectrip.controller.system.login;
...
import com.ectrip.util.RightsHelper;
import com.ectrip.util.Tools;
/**
 * 总入口
 * @author ectrip QQ 3 1 3 5 9 6 7 9 0[青苔]
 * 修改日期：2015/11/2
 */
@Controller
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").split(",ectrip,");
