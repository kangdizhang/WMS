...
<div class="main-container pagination pagination-right" id="main-container">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <form action="pms/columns.do" method="post" name="Form" id="Form">
                <table style="margin-top:5px;">
                    ...
                    <table id="simple-table" class="hovertable" style="margin-top:0px;">
                        <tr>
                            ...
                            <th class="center">保留小数点位数</th>
                            <th class="center">不允许空</th>
                        </tr>
                        <tbody>
                        <!-- 开始循环 -->
                        <c:choose>
                            <c:when test="${not empty varList}">
                                <c:forEach items="${varList}" var="var" varStatus="vs">
                                    <tr onmouseover="this.style.backgroundColor='#ffff66';"
                                        ...
                                        <td class='center'>${var.columnName}</td>
                                        <td class="center">${var.columnLength}</td>
                                        <td class="center">${var.columnType}</td>
                                        <td class="center">${var.columnMark}</td>
                                        <td class="center">${var.columnScale}</td>
                                        <td class="center">${var.notNull}</td>
                                    </tr>
                                </c:forEach>
                            </c:when>
                            <c:otherwise>
