...
<div class="main-container pagination pagination-right" id="main-container">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <!-- 检索  -->
            <form action="pms/list.do" method="post" name="Form" id="Form">
                    ...
                    <table style="margin-top:5px;">
                        <tr>
                            ...
                            <td style="vertical-align:top;padding-left:2px;">
                                ...
                                <a href="pms/compareTable.do" class="button">对比P46/P461表结构</a>
                            </td>
                        </tr>
                    </table>
                    <!-- 检索  -->
                    <table id="simple-table" class="hovertable" style="margin-top:0px;">
                        <tr>
                            <th style="width:50px;">表名</th>
                            <th class="center">类型</th>
                            <th class="center">备注</th>
                            <th class="center">主键信息</th>
                            <th class="center">外键</th>
                            <th class="center">聚集索引</th>
                            <th class="center">非聚集索引</th>
                            <th class="center">触发器</th>
                        </tr>
                        <tbody>
                        <!-- 开始循环 -->
                        <c:choose>
                            <c:when test="${not empty varList}">
                                <c:forEach items="${varList}" var="var" varStatus="vs">
                                    <tr onmouseover="this.style.backgroundColor='#ffff66';"
                                        ...
                                        <td class='center' style="width: 30px;">${var.TABLE_NAME}</td>
                                        <td class="center">${var.TABLE_TYPE}</td>
                                        <td class="center">${var.COMMENTS}</td>
                                        <td class="center">${var.PK_INFO}</td>
                                        <td class="center">${var.FK_INFO}</td>
                                        <td class="center">${var.UNIQUE_COLUMN}</td>
                                        <td class="center">${var.NON_COLUMN}</td>
                                        <td class="center">${var.TRI_INFO}</td>
                                    </tr>
                                </c:forEach>
                            </c:when>
                            <c:otherwise>
